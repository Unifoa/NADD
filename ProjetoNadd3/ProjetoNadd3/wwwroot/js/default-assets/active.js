(function ($) {
    ...
    var nadd_window = $(window);

    // ****************************
    // :: 1.0 Preloader Active Code
    // ****************************

    nadd_window.on('load', function () {
    ...
    // ****************************
    if ($.fn.imagesLoaded) {
        $('.nadd-portfolio-area, .nadd-blog-masonary').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.nadd-portfolio-area, .nadd-blog-masonary').isotope({
                itemSelector: '.nadd-portfolio-item, .nadd-blog-masonary-item',
                percentPosition: true,
                masonry: {
                    columnWidth: '.nadd-portfolio-item, .nadd-blog-masonary-item'
                }
            });
        });
    }
